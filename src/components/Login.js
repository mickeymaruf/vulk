...
const Login = () => {
    ...
    return (
        <div className="hero min-h-screen bg-slate-900">
            <form onSubmit={handleLogin} className="bg-slate-800 w-11/12 sm:w-8/12 md:w-7/12 lg:w-5/12 xl:w-4/12 px-10 py-8 rounded-lg mx-auto mt-16">
                ...
                <div className='mb-3'>
                    ...
                    <input type="password" name="password" placeholder="Enter your password" className="w-full p-3 outline-0 border-2 border-slate-700 focus:border-indigo-500 rounded-lg bg-slate-900 mt-1" />
